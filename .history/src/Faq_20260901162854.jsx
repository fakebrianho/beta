...
const FAQS = [
  {
    q: "What is Beta?",
    a: "I was fucking around making a mini coaching app that allows users to submit videos for review, and coaches to timestamp comment / annotate the videos. Somewhere along the way I added a gallery for B37 spray wall sets and",
  },
  {
    q: "What's a bounty?",
    a: "A route marked 💰 Bounty hasn't been climbed by anyone yet. Be the first to send it and submit a video as proof — you claim the FA (first ascent) and your name goes on the route.",
  },
  {
    q: "How do I submit a send?",
    a: "Open a route in the gallery, scroll to the send form, enter your name, optionally your grade opinion, and upload a video of you doing the problem start to finish. If you're not signed in you'll also need the gym passcode — ask at the front desk.",
  },
  {
