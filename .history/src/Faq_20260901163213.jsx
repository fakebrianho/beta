...
const FAQS = [
  ...
  },
  {
    ...
    a:"If you're signed up, when you send a route you get points based on how many attempts it took. If you get an FA it's 5000 points, a flash is 3000 points (does not add onto the 5000 if it's "
  },
  {
